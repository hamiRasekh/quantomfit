...
export const _userAbout = {
  ...
  quote:
    'من عاشق کیک جو هستم. رول‌های شیرین کارامل و آبنبات‌های شیرین را دوست دارم. کیک و ویفر را ترجیح می‌دهم.',
  socialLinks: {
...
export const _userFeeds = Array.from({ length: 3 }, (_, index) => ({
  ...
  comments: (index === 2 && []) || [
    ...
    },
    {
      ...
      message:
        'این یک متن نمونه برای نمایش کامنت است. این متن به صورت تصادفی تولید شده و تنها برای نمایش استفاده می‌شود.',
    },
  ],
}));

...
import { UploadIllustration } from '@/ui/assets/illustrations';
...
export function Upload({
  ...
  const titleText = placeholderTitle ?? (multiple ? 'Drop or select files' : 'Drop or select a file');
  const descriptionText =
    placeholderDescription ?? (multiple ? 'Drag files here, or browse your device.' : 'Drag a file here, or browse your device.');
  ...
  const renderPlaceholder = () => {
    ...
    <PlaceholderContainer className={uploadClasses.placeholder.root}>
      ...
      <div className={uploadClasses.placeholder.content}>
          <div className={uploadClasses.placeholder.title}>{titleText}</div>
          <div className={uploadClasses.placeholder.description}>{descriptionText}</div>
      </div>

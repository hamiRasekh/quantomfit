...
export function NavList({
  ...
  const { value: open, onTrue: onOpen, onToggle } = useBoolean(isActive);

  // وقتی مسیر عوض می‌شود فقط بخش حاوی لینک فعلی را باز کن؛ بقیه را بسته نکن تا وضعیت سایدبار حفظ شود
  useEffect(() => {
    if (isActive) {
      onOpen();
    }
  }, [pathname, isActive, onOpen]);

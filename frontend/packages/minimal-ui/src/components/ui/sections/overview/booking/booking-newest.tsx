...
import { fDateTime } from '@/ui/utils/format-time';
import { Carousel, useCarousel, CarouselArrowBasicButtons } from '@/components/ui/carousel';
...
function CarouselItem({ item, sx, ...other }: ItemProps) {
  return (
    <Box
      sx={[
        {
      ...
      {...other}
    >
      <IconButton sx={{ position: 'absolute', top: 8, right: 8, zIndex: 1 }} size="small">

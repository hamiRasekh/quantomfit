...
import { SeoIllustration } from '@/ui/assets/illustrations';
import { svgColorClasses } from '@/components/ui/svg-color';
import { _appAuthors, _appRelated, _appFeatured, _appInvoices, _appInstalled } from '@/ui/_mock';

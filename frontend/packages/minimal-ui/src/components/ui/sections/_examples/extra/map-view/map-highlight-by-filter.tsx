...
import { Map, MapPopup, MapControls } from '@/components/ui/map';
  ...
  return (
    ...
    >
      ...
      <Source
        id="counties"
        type="geojson"
        data="https://raw.githubusercontent.com/visgl/deck.gl-data/refs/heads/master/examples/ar@/ui/theme/counties.json"
      >

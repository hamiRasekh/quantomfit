...
import type { LangCode } from '@/ui/locales';
...
import { fDate } from '@/ui/utils/format-time';
import { FlagIcon } from '@/components/ui/flag-icon';
import { allLangs, useTranslate } from '@/ui/locales';
import { NavSectionVertical } from '@/components/ui/nav-section';
import { fData, fNumber, fPercent, fCurrency, fShortenNumber } from '@/ui/utils/format-number';
  ...
  const renderMenu = () => (
    ...
    >
      ...
      <RadioGroup
        ...
        onChange={(event) => {
          trans.onChangeLang(event.target.value as LangCode);
        }}
      >
        {allLangs.map((lang) => (
          <FormControlLabel
    ...
    },
    {
      ...
      component: (
        ...
        >
          ...
          >
            <DatePicker label="Input" value={date} onChange={(newValue) => {
              if (newValue === null) {
                setDate(null);

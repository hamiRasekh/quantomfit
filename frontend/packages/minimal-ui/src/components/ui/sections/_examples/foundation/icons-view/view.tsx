...
import { countries } from '@/ui/assets/data';
  ...
  },
  {
    ...
    component: (
      <ComponentBox>
        ...
        <FileThumbnail
          showImage
          file="https://assets.voody.app@/ui/theme/publi@/ui/theme/assets/images/mock/cover/cover-1.webp"
        />
        <FileThumbnail file="unknown" />
      </ComponentBox>
    ),
  },
  {

...
import type { ICalendarEvent, ICalendarFilters } from '@/types/calendar';
...
import { fDate, fDateTime } from '@/ui/utils/format-time';
import { ColorPicker } from '@/components/ui/color-utils';
  ...
  const handleFilterStartDate = useCallback(
    (newValue: PickerValue) => {
      if (newValue === null) {
        ...
        updateFilters({ startDate: dayjs(newValue) });
      } else {
  ...
  const handleFilterEndDate = useCallback(
    (newValue: PickerValue) => {
      if (newValue === null) {
        ...
        updateFilters({ endDate: dayjs(newValue) });
      } else {

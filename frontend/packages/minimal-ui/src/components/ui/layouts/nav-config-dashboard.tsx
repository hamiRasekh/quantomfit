...
export const navData: NavSectionProps['data'] = [
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Design', path: paths.dashboard.design, icon: ICONS.design },
    ...
    items: [
      {
         ...
         * Example usage can be found in: @/ui/sections/_examples/extra/navigation-bar-view/nav-vertical.{jsx | tsx}
         */
        title: 'Permission',

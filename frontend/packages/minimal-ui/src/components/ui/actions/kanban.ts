...
import type { IKanban, IKanbanTask, IKanbanColumn } from '@/types/kanban';

import useSWR, { mutate } from 'swr';
import { useMemo, startTransition } from 'react';

import axios, { fetcher, endpoints } from '@/ui/lib/axios';
...
export async function deleteTask(columnId: IKanbanColumn['id'], taskId: IKanbanTask['id']) {
  /**
   * Work on server
   */
  if (enableServer) {

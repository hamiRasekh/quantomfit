...
import { _id, _postTitles } from '@/ui/_mock/assets';
...
export const paths = {
  ...
  docs: 'https://docs.voody.app@/ui/theme/',
  changelog: 'https://docs.voody.app@/ui/theme/changelog/',
  ...
  dashboard: {
    ...
    assignments: {
      ...
      list: `${ROOTS.DASHBOARD}/assignments`,
      details: (id: string) => `${ROOTS.DASHBOARD}/assignments/${id}`,
    },
  },
};

...
import type { UseDateRangePickerReturn, DateValue } from './use-date-range-picker';
  ...
  return (
    ...
    >
      ...
      >
        {isCalendarView ? (
          <>
            <DateCalendar value={startDate} onChange={(value) => onChangeStartDate(value as DateValue)} />
            <DateCalendar value={endDate} onChange={(value) => onChangeEndDate(value as DateValue)} />
          </>
        ) : (
          <>
            <DatePicker label="Start date" value={startDate} onChange={(value) => onChangeStartDate(value as DateValue)} />
            <DatePicker label="End date" value={endDate} onChange={(value) => onChangeEndDate(value as DateValue)} />
          </>
        )}
